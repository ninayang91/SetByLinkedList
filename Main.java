...
/*		
		...
		int[] a3={1,2,3};
		int[] a4={-5,6,10,11,16};
		DLLSet set1=new DLLSet(a1);
		DLLSet set2=new DLLSet(a2);
		DLLSet set3=new DLLSet(a3);
		DLLSet set4=new DLLSet(a4);
		DLLSet[] array={set1,set2,set3,set4};
		DLLSet set=DLLSet.recUnion(array);
		System.out.println(set);*/
/*        int m= 16; //size of array of sets
        int[] set2={ -9, -4, 0, 6}; //sorted
	int[] set6={-20, 4, 9, 77};//to test union, intersection
	...
	//
       ...
       DLLSet setObj3 = DLLSet.recUnion(sets);
       System.out.println("union: \n"+setObj3.toString());
       System.out.println("size of union = " + setObj3.getSize());*/
		
		//DLLSet set=recUnion(array);
		//System.out.println(set);
		
		//DLLSet set2=set.copy();
		//System.out.println(set);
		//System.out.println("*******************");
/*		set.add(7);
		set.add(7);
